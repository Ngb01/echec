...
import projetechec.view.EchecVueTextuelle;
import projetechec.controler.CaseControler;
import projetechec.controler.PromotionControler;
 ...
 * @author lebas
 */
public class EchecVueFrame extends javax.swing.JFrame implements Observateur {
    ...
    public EchecVueFrame(EchecModel modele) {
        ...
        // On dessine le plateau et on place les pièces
    ...
    // Fonction qui permet de retourner l'image associée à la pièce
    ...
    // Fonction qui retourne l'icone dans une case
    public ImageIcon getIcon(int i, int j){
        return getIconFromInt(this.modele.getCase(i, j));
    }
    
    
    // Fonction qui réinitialise les couleurs des cases du plateau
    void resetColor(){
        for(int i=0;i<TAILLE;i++){
            for(int j=0;j<TAILLE;j++){
                if((j+i)%2==0){
    ...
    // Fonction qui réinitiliase le plateau et replace les pièces
    void initBoardPanel(){
        for(int i=0;i<TAILLE;i++){
            for(int j=0;j<TAILLE;j++){
                if((j+i)%2==0){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EchecVueFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                EchecVueFrame eframe = new EchecVueFrame(em);
    ...
    // Fonction qui colore les cases pouvant recevoir un déplacement
    @Override
    ...
    // Fonction qui bouge les pièces après un déplacement
    @Override
    ...
    // Fonction qui réinitialise le plateau pour une nouvelle partie
    @Override
    ...
    // Fonction qui avertit de la fin de partie
    @Override
    ...
    // Fonction qui avertit de la mise en danger du roi en cas de déplacement
    @Override
    ...
    // Fonction qui avertit de la mise en Echec
    @Override
    ...
    // Fonction qui demande de choisir une pièce pour la promotion du pion
    @Override
    ...
    // Fonction qui réalise le roque sur le plateau de jeu
    @Override
