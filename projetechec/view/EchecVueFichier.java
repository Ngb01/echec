...
public class EchecVueFichier implements Observateur{
    ...
    // Fonction qui écrit dans un fichier pour notifier des déplacements réalisées
    @Override
    ...
    // Fonction qui écrit dans un fichier pour notifier de la promotion d'un pion
    @Override
    ...
    // Fonction qui écrit dans un fichier pour notifier de la mise en danger du Roi
    ...
    // Fonction qui écrit dans un fichier pour notifier de la réalisation d'un roque
    @Override
    ...
    // Fonction qui écrit dans un fichier pour notifier de la mise en Echec
    @Override
    ...
    // Fonction qui écrit dans un fichier pour notifier du début d'une nouvelle partie
    @Override
    ...
    // Fonction qui écrit dans un fichier pour notifier de la fin d'une partie
    @Override
